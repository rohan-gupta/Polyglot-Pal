...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-10 col-md-10 col-lg-10">
            ...
            <p class="text-center heading">Posts so far</p>
            
            <div class="feed">
                <?php
                    $sql = "select * from post where Language = '$lang1' or Language = '$lang2' order by PID desc";
                ...
                ?>
            		...
            		<div id="post" class="animated fadeInUp">
                        ...
                        <div id="post-box">
                            ...
                            <p class="inline"><?php echo give_name($uid,$connection)."<span style='margin-left: 400px; font-weight:100; font-size: 15px;'>(".$row['Language'].")</span>"; ?></p>

                            <hr>
                                
                            <p class="post"><?php echo $row['Content']; ?></p>
                            
                            <hr>

                            <form class="form-inline text-center" action="save_comment.php" method="POST">
                    ...
                    <?php
                        ...
                        $comment_res = give_comment($pid,$connection);
