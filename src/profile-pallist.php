...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10" style="padding: 0px;">
            <p class="heading text-center">Pal List</p>
            ...
            <?php
                ...
                $sql2 = "SELECT * from friends where UserID1 = $id or UserID2 = $id";
                ...
                if(mysqli_num_rows($result2) > 0){
                    while($row2 = mysqli_fetch_assoc($result2)){
                        $i++; 
                        if($id != $row2['UserID2']){
                            $name = give_name($row2['UserID2'],$connection);
                            
                            echo "<a class='link' href='profile-view-two.php?user=".$row2['UserID2']."'>".$i." ".$name."</a>"."<br>";
                        }
                        else if($id != $row2['UserID1']){
                            $name = give_name($row2['UserID1'],$connection);
                            
                            echo "<a class='link' href='profile-view-two.php?user=".$row2['UserID1']."'>".$i." ".$name."</a>"."<br>";
                        }
                    }
                }
                else{
